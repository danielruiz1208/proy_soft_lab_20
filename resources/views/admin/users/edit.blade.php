                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.users.update', $user) }}" class="space-y-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="user" class="block mt-1 w-full" type="text" name="user" :value="old('user', $user->user)" required />
                        ...
                        <div>
                            ...
                            <select id="rol" name="rol" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                <option value="admin" @selected(old('rol', $user->rol) === 'admin')>{{ __('Administrador') }}</option>
                                <option value="usuario" @selected(old('rol', $user->rol) === 'usuario')>{{ __('Usuario') }}</option>
                            </select>
